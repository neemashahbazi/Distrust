...
for iteration in range(5):
    ...
    columns_to_scale = ['bedrooms', 'bathrooms', 'sqft_living', 'sqft_lot', 'waterfront', 'view', 'condition', 'grade', 'sqft_above', 'sqft_basement', 'yr_built', 'yr_renovated', 'lat', 'long', 'sqft_living15', 'sqft_lot15']
    columns_to_encode = ['floors', 'zipcode']
...
plt.savefig("results/effectiveness/regression/house_binned_trust_wdt.png")
...
plt.savefig("results/effectiveness/regression/house_binned_trust_sdt.png")
# ===================================================
# # Plot
...
#
# WDT: [12819, 771, 572, 436, 456, 389, 355, 453, 585, 887]
# SDT: [15186, 583, 453, 395, 334, 331, 412, 29]
# mse wdt [16424832663.22749, 37230088288.77147, 30422351038.146156, 45694233752.15963, 56486271071.76842, 83328102388.55937, 125404979380.44846, 78022761168.8362, 113372059518.48856, 410514787767.725]
# mse sdt [20208509800.601543 116098141573.41338 82646231652.2649 119501773636.54483 105939202793.17786 264137902570.27374 587850821039.3077 718684570344.8275]
# Pearson Correlation Conservative:  0.4359829501359503
# Pearson Correlation Liberal:  0.4027080470467664