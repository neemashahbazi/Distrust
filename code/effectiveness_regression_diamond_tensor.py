...
for iteration in range(1):
    ...
    model.fit(x_train_scaled, y, epochs=150, batch_size=10)
    ...
    for key in sorted(dict_conservative_features):
        ...
        y_pred = model.predict(np.stack(dict_conservative_features[key]))
    ...
    for key in sorted(dict_liberal_features):
        ...
        y_pred = model.predict(np.stack(dict_liberal_features[key]))
...
plt.savefig("../results/effectiveness/regression/diamond_binned_trust_wdt_tensor.png")
...
plt.savefig("../results/effectiveness/regression/diamond_binned_trust_sdt_tensor.png")
# ===================================================
# # Plot
